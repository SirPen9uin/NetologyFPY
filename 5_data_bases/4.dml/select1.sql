--Основы
--выберем поля из таблицы film
SELECT * FROM film;

--выберем столбец title из таблицы film
...
--сортируем по нескольким столбцам: по продолжительности и цене проката
SELECT title, length, rental_rate FROM film
ORDER BY length DESC, rental_rate DESC;

--найдем IDб имена, фамилии актеров чья фамилия содерит li,
